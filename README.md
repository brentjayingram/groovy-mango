...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/606f667a3bab73001685360c
...
To start editing your site, you can use the Sanity interface at https://groovy-mango-f667a.sanity.studio/.
...
Generated at `2021-04-08T20:26:17.742Z` by Stackbit version `0.3.50`.